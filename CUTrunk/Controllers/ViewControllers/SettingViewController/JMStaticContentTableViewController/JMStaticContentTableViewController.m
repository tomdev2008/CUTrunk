...
- (UIView*) tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    [label setText:[NSString stringWithFormat:@"    %@",sectionContent.title]];
    [label setFont:[UIFont systemFontOfSize:12]];
    [label setBackgroundColor:[UIColor clearColor]];
    label.textColor = RGB(140.,143.,145.);
...
- (UIView*) tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    [label setText:sectionContent.footer];
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.textColor = RGB(89, 94, 98);
   
    cell.detailTextLabel.textColor =  RGB(165,169,170);
    ...
    cell.layer.cornerRadius = 0.0f;//直角
...
- (void) setHeaderText:(NSString *)headerTextValue {
	...
	if([self isViewLoaded]) {
		...
		headerLabel.textColor = RGB(140.,143.,145.);
...
- (void) setFooterText:(NSString *)footerTextValue {
	...
	if([self isViewLoaded]) {
		...
		footerLabel.textColor = RGB(140.,143.,145.);
